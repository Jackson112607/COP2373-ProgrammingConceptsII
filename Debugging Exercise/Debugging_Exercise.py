...
def main():
    ...
    products = [
        ...
        {"name": "Tablet", "price": 500, "discount_rate": 0.2},         # Price of table should not be in quotes, causes TypeError.
                                                                        # (Cannot complete calculation with a string rather than an integer.)
